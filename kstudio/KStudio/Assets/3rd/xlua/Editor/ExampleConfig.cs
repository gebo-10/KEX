...
public static class ExampleConfig
{
    ...
    static List<string> exclude = new List<string> {
        ...
        "LightingSettings","MeshRenderer","CanvasRenderer","ParticleSystemRenderer","DefaultControls"
    };
        ...
        get
        {
            ...
            var delegate_types = new List<Type>() {
                ...
                //typeof(EventHandler),
                 ...
                 //typeof(Action<MessageType, LuaTable>),
            };
            ...
            return delegate_types.Where(t => t.BaseType == typeof(MulticastDelegate) ).Distinct().ToList();
        }
    }
    //--------------end 纯lua编程配置参考----------------------------
    ...
    [DoNotGen]
    public static List<Type> DoNotGen = new List<Type>()
    {
    ...
    public static List<List<string>> BlackList = new List<List<string>>()  {
                new List<string>(){ "LuaComponent", "Message"},
