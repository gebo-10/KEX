...
void reg_object(sol::table& lua) {
	{
		sol::usertype<kengine::Component> type = lua.new_usertype<kengine::Component>("Component"
			,sol::constructors <
	...
	{
		sol::usertype<kengine::Transform> type = lua.new_usertype<kengine::Transform>("Transform"
			,sol::constructors <
			kengine::Transform ()
			> ()
	...
	{
		sol::usertype<kengine::MeshRender> type = lua.new_usertype<kengine::MeshRender>("MeshRender"
			,sol::constructors <
			kengine::MeshRender ()
			> ()
			,sol::base_classes, sol::bases<kengine::Component>()
	...
	{
		sol::usertype<kengine::MeshSkin> type = lua.new_usertype<kengine::MeshSkin>("MeshSkin"
			,sol::constructors <
			kengine::MeshSkin ()
			> ()
			,sol::base_classes, sol::bases<kengine::Component>()
	...
	{
		sol::usertype<kengine::Light> type = lua.new_usertype<kengine::Light>("Light"
			,sol::constructors <
			kengine::Light ()
			> ()
			,sol::base_classes, sol::bases<kengine::Component>()
	...
	{
		sol::usertype<kengine::Object> type = lua.new_usertype<kengine::Object>("Object"
			,sol::constructors <
			kengine::Object ()
			> ()
		);
